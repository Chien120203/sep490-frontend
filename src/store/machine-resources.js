...
export const userMachineResourcesStore = defineStore(
    "machineResources",
    () => {
        const {t} = useI18n();
        ...
        const getListMachineResources = async (params, isLoading = true) => {
            ...
            await services.MachineResourcesAPI.list(
                params,
                (response) => {
        ...
        const getMachineResourcesDetails = async (params) => {
            ...
            await services.MachineResourcesAPI.details(
                params,
                (response) => {
        ...
        const saveMachineResources = async (params, method) => {
            ...
            await services.MachineResourcesAPI[method](
                formData,
                (response) => {
                    if(response.success) {
                        machineResourcesDetails.value = response.data;
        ...
        const handleDeleteMachineResources = async (id) => {
            mixinMethods.startLoading();
            await services.MachineResourcesAPI.deleteMachine(
                id,
                (response) => {
                    if(response.success) {
